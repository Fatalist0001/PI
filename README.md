...
| **Гибкая**                 | - Максимальное вовлечение заказчика <br> - Работа с требованиями <br> - Интеграция тестирования и разработки <br> - Минимум документации                | - Сложность масштабирования <br> - Трудности со стабильными процессами                                           | - В определённые моменты итераций и **в любой необходимый момент** <br> - Поддержка TDD, BDD, CI/CD |
